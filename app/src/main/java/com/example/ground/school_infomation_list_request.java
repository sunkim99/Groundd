...
//학교 게시판 상세 내용 요청하기
public class school_infomation_list_request extends StringRequest {
    ...
    public school_infomation_list_request(Integer schnotNum, Response.Listener<String>listener){
