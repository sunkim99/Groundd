...
public class config_my_forum_forum extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        config_my_forum_forum.GetData task = new config_my_forum_forum.GetData();
        task.execute("http://olivia7626.dothome.co.kr/Config_My_Forum.php");
           ...
           // String userID = ID.getID();
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        config_my_forum_forum.this, mArrrayList,R.layout.item_list,
